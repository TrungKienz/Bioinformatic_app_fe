    ...
    <PageContainer>
      <Form {...layout} layout="inline" onFinish={handleSearch}>
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: 'Hãy chọn loại bệnh án!' }]}
        >
          <Select
            style={{ width: '170px' }}
      ...
      <ModalForm
        ...
        trigger={
          <Button icon={<FileAddOutlined />} style={{ margin: '20px 0' }}>
            Thêm bệnh án
          </Button>
        }
        onFinish={(values) => {
      ...
      >
        <ProFormSelect options={typeHealthRecord} name="typeHealthRecord" />
      </ModalForm>
