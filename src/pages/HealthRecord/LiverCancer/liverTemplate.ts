const LUNG: any = {
    generalInfo: [
        {
            ...
            listQuestions: [
                ...
                [
                    [
                        {
                            listChoice: ['Tiểu sử gia đình (xét người thân trong gia đình ít nhất 3 thế hệ) nhiễm viên gan (VGB, VGC) và ung thư biểu mô tế bào gan'],
                            type: 'checkbox',
                            answer: [false],
                        },
                    ],
            ...
            listQuestions: [
                ...
                [
                    ...
                    [
                        {
                            question: 'Thuốc',
                            listChoice: ['Sorafenib', 'Lenvantinib', 'Regorafenib', 'Pembrolizumab', 'Khác (ghi rõ):'],
                            type: 'checkbox',
...

        {
            ...
            listQuestions: [
                ...
                [
                    [
                        { question: 'Tải lượng virus (nếu có):', type: 'none' }
                    ],
                    [
                        { type: 'text' }
                    ]
                ...
                [
                    [
                        ...
                        {
                            question: 'Kết quả chẩn đoán hình ảnh (ưu tiên kết quả cận lâm sàng có giá trị lớn nhát)',
                            type: 'none',
                        },
                        {
    ...
    treatmentAndFollowUpAfterTreatment: {
        listQuestions: [
            [
                [
                    {
                        question: '28.	Phương pháp điều trị (cùng hoá chất) ',
                        type: 'title',
                    },
                ],
                [
                    {
                        listChoice: ['Phãu thuật'],
                        type: 'checkbox',
                        answer: [false],
                    },
                    {
                        question: '',
                        unit: 'Số phân thuỷ cắt:',
                        type: 'text',
                        answer: '',
                    },
                    {
                        question: '',
                        unit: 'Thể tích gan còn lại',
                        type: 'text',
                        answer: '',
                    },
                ],
                ...
                [
                    ...
                    {
                        question: 'Hoá chất nút mạch',
                        listChoice: ['0. Không', '1. Có'],
                        type: 'radio',
                    },
                ],
                [
                ...
                [
                    {
                        listChoice: ['Xã trị chọn lọc ĐM gan (bằng Y-90)'],
                        type: 'checkbox',
                        answer: [false],
                    },
                    {
                ...
                [
                    ...
                    },
                    {
                        question: '',
                        unit: 'Thuốc:',
                        listChoice: ['Sorafenib', 'Lenvatinib', 'Regorafenib', 'Pembrolizumab', 'Khác (Ghi rõ)'],
                        type: 'checkbox',
                        answer: [false, false, false, false, false],
                    },
                ],
            ...
            [
                [
                    {
                        question: '29. Phác đồ hoá chất sử dụng ',
                        type: 'title',
                    },
                ],
                [
                    {
                        question: '',
                        listChoice: ['Phác  đỒ PLAF', 'Phác đồ GEMOX', 'Phác đồ FOLFOX 4', 'Khác (ghi rõ)'],
                        type: 'checkbox',
                        answer: [false, false, false, false]
                    },
                ]
            ...
            [
                {
                    question: 'Triệu chứng lâm sàng sau điều trị',
                    type: '',
                },
                [
                    { question: 'Sau 1 tháng', type: 'none' },
                    {
                        type: 'select',
                ...
                [
                    [
                        {
                            question: 'Xét nghiệm sau điều trị',
                            type: '',
                        },
                    ],
                    [
                ...
                [
                    [
                        {
                            question: 'Đánh giá đáp ứng điều trị (theo mRECIST)',
                            type: '',
                        },
                    ],
                    [
                    ...
                    [
                        [
                            {
                                question: 'Tử vong trong 05 năm theo dõi',
                                listChoice: ['0. Không', '1. Có'],
                                type: 'checkbox',
                                answer: [false, false]
                            },
