        ...
        "listQuestions": [
            ...
            [
                [
                    {
                        "listChoice": [
                            "Tiếp xúc với độc tố hoặc hoá chất"
                        ],
                        "type": "checkbox",
                        "answer": [
                            false
        ...
        "listQuestions": [
            ...
            [
                [
                    {
                        "listChoice": [
                            "Xạ trị chọn lọc ĐM gan (bằng Y-90)"
                        ],
                        "type": "checkbox",
                        "answer": [
                            false
            ...
            [
                [
                    {
                        "listChoice": [
                            "Truyền hoá chất qua động mạch gan (Cisplatin với 5FU liều thấp)"
                        ],
                        "type": "checkbox",
                        "answer": [
                            false
        ...
        "listQuestions": [
            ...
            [
                [
                    {
                        "listChoice": [
                            "Đau hạ sườn phải (thang VAS: 0-10 điểm)"
                        ],
                        "type": "checkbox",
                        "answer": "",
                        "key": ""
            ...
            [
                [
                    {
                        "listChoice": [
                            "Phù vị trí khác (chân, tràn dịch màng phổi, màng tim, mặt,...)"
                        ],
                        "type": "checkbox",
                        "answer": [
                            false
    ...
    },
    {
        ...
        "listQuestions": [
            ...
            [
                [
                    {
                        "question": "Kết quả chẩn đoán hình ảnh (ưu tiên kết quả cận lâm sàng có giá trị lớn nhất)",
                        "type": "none",
                ...
                [
                    {
                        "type": "checkbox",
                        "listChoice": [
                            "Thuốc kháng virus viêm gan (nếu có)"
                        ],
                        "answer": [
                            false
                        ],
