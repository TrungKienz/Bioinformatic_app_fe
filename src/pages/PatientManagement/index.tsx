...
//           <Button type="primary" onClick={() => next()} style={{position: 'absolute', right: '40px'}}>
//             Next
//           </Button>
//         )}
//         {current === steps.length - 1 && (
//           <Button type="primary" onClick={() => message.success('Processing complete!')} style={{position: 'absolute', right: '40px'}}  >
//             Done
//           </Button>
//         )}
//         {current > 0 && (
//           <Button style={{ margin: '0 8px', position: 'absolute', right: '105px' }} onClick={() => prev()} >
//             Previous
//           </Button>
//         )}
//       </div>
  ...
  return (
    ...
    >
        <StepsForm.StepForm style={{margin: "0 0 25px 0"}} name="step1" title="Thông tin bệnh nhân">
            <PageContainer title={"Thông tin bệnh nhân"} style={{background: "#ffffff", borderRadius: "6px"}}>
                <ProFormText
                    width="md"
                    name="id"
                    label="Mã bệnh nhân"
        ...
        <PageContainer title={"Thông tin lâm sàng"} style={{background: "#ffffff", borderRadius: "6px"}}>
            <ProForm.Group>
                <ProFormSelect
                ...
                <ProForm.Group title="Hóa sinh máu">
                    ...
                    <ProFormText
                        name="creatimin"
                        width="sm"
                        label="Creatimin(mol/L)"
                        placeholder=""
                    />
                </ProForm.Group>
            </PageContainer>
        </StepsForm.StepForm>
        <StepsForm.StepForm style={{margin: "0 0 25px 0"}} name="step3" title='Thông tin xét nghiệm gen'>
        <PageContainer title={"Thông tin xét nghiệm gen"} style={{background: "#ffffff", borderRadius: "6px"}}>
            <ProForm.Group>
                <ProFormSelect
                    // colProps={{ xl: 8, md: 12 }}
                    width="md"
